...
// let ucFirst = (str) => str[0].toLocaleUpperCase() + str.substring(1);

// console.log(ucFirst('myfreedom'));
...
// let checkSpam = (str) =>{
//     return (str.toLowerCase().includes("badWord".toLowerCase()) || str.toLowerCase().includes("XXX".toLowerCase()));
// };
...
// console.log(strBox('привет Женя'));
